...
const Sidebar = ({ isOpen, setIsOpen, isMobile = false }) => {
    ...
    return (
        <div className={clsx(
            ...
            {/* Header / Logo Area */}
            <div className="flex items-center justify-between h-20 px-6 border-b border-[#1E293B]">
                <div className="flex items-center gap-3">
                    {!isCollapsed && <span className="text-xl font-bold text-white tracking-tight">AI Job Portal</span>}
                </div>

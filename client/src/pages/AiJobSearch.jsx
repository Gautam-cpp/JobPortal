                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-4">
                        {jobs.map((job, index) => (
                            <a
                                ...
                                className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg hover:border-blue-300 transition-all group flex flex-col justify-between"
                            >
                                <div>

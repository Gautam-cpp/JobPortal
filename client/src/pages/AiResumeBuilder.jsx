                ...
                <section className="mb-8">
                    ...
                    <div className="relative">
                        <textarea
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm h-20 resize-none pr-32"
                        ...
                        <div key={index} className="p-4 bg-slate-50 rounded-xl border border-slate-200 mb-4 space-y-3">
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    className="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-sm h-24 resize-none pr-32"
                                />
                                <button
